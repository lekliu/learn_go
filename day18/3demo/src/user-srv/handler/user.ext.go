...
import (
	"context"
	"demo/src/share/errors"
	"demo/src/share/pb"
	"demo/src/user-srv/db"
	"go.uber.org/zap"
)
...
//
//	"context"
//	"my-micro/demo/src/share/errors"
//	"my-micro/demo/src/share/pb"
//	"my-micro/demo/src/share/utils/log"
//	"my-micro/demo/src/user-srv/db"
//	"go.uber.org/zap"
//
// )
...
func (u *UserServiceExtHandler) ResetAccount(ctx context.Context, req *pb.LoginAccountReq, rsp *pb.LoginAccountRsp) error {
	return nil
}

func (u *UserServiceExtHandler) WantScore(ctx context.Context, req *pb.LoginAccountReq, rsp *pb.LoginAccountRsp) error {
